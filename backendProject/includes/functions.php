<?php
    ...
    function getResults ($dbcnx, $fields) {
        $query = "SELECT" . $fields . "FROM homestbl"; // CHANGE THIS TO HOUSETBL WHEN NEEDED!
    ...
    function getPickyRow($dbcnx, $fields,$homeName){

         $query = "SELECT " . $fields . "FROM homestbl WHERE homeName = '$homeName'" ; 
     ...
     //DO THIS AT HOME !!! 
     //
    function insertNewHome($dbcnx,$homeName, $homePrintname, $price, $description, $numRooms, $numBaths, $numParks, $lotSize, $orderNum ){
